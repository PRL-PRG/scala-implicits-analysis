...
//
//object ExportImplicitConversion extends ExporterApp {
//
...
//  }
//
//  private def isConversion(d: Declaration): Boolean = {
//    true
////    d.isImplicit && {
////      d.signature.value match {
////        case MethodSignature => true
////        case TypeSignature => true
////        case _ => false
////      }
////    }
//  }
...
//      declaration <- idx.implicitDeclarations if isConversion(declaration)
