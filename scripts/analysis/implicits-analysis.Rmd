...
patterns_human_name <- function(x) {
  case_when(
    ...
    x=="TCM"  ~ "Type Classess - Methods",
    x=="TCT"  ~ "Type Classess - Types",
    x=="TP"   ~ "Type Proofs",
...
pattern_type_class_m <- pattern_summary("TCM", pattern_type_class_m_ds, pattern_type_class_m_cs)
```
...
pattern_context_m <- pattern_summary("CTXM", pattern_context_m_ds, pattern_context_m_cs)
```
